...
# ===== 最大CC源点个数估计配置 =====
COUNT_HEAD_DROPOUT = 0.10
COUNT_LOSS_WEIGHT = 0.30
COUNT_MODEL_SELECTION_WEIGHT = 0.12
COUNT_GUIDED_TOPK_BOOST = 0.35
COUNT_GUIDED_NON_TOPK_DECAY = 0.45
COUNT_GUIDED_OUTSIDE_MAXCC_DECAY = 0.70
COUNT_GUIDED_MIN_SELECTION = 1
